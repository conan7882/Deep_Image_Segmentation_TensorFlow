...
import tensorcv
from tensorcv.dataflow.dataset import BSDS500
...
DATAPATH = 'E:\\GITHUB\\workspace\\CNN\\dataset\\BSR_bsds500\\BSR\\BSDS500\\data\\'
VGGPATH = 'E:\\GITHUB\\workspace\\CNN\\pretrained\\vgg19.npy'
...
def get_config(FLAGS):
    ...
    inference_list_test = [
                          InferImages('output/pre_label', 'edge')
                    ]
